...
<head>
    ...
    <title>PEA DATA ARCHITECT - DMC</title>
...
<style>
    ...
    .fondito {
        background: url(https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/portada-da.png);
...
<body style="background-color: #2c2c2c;">
    <div class="whats-float">
        <a href="https://wa.me/51981459715" target="_blank">
            <i class="fa fa-whatsapp"></i><span>WhatsApp<br><small>+51 981459715</small></span>
        </a>
    </div>
    <div class="container-sm fondito">
        <div class="row">
            <div class="col-md-7">
                <img src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/portada-da.png" width="100%" alt="">
            </div>
            <div class="col-md-4">
                <div class="row form">
                    <form method="post" id="form" name="form" action="controller/controller_suscripcion.php">
                        <input type="hidden" name="cursos" id="cursos" value="3207">
                        <input type="hidden" name="redirect" value="5">
                        <input type="hidden" name="atendido" id="atendido" value="0">
                        <input type="hidden" name="nomCapacitacion" id="nomCapacitacion" value="PEA DATA ARCHITECT">
                        <input type="hidden" name="brch" value="https://dmc.pe/wp-content/uploads/2023/04/Brochure-PEDA20241.pdf">
            ...
            <div class="col-md-6" style="background-color: white;">
                <div class="row justify-content-center">
                    <div class="col-9">
                        ...
                        font-size: 22px;
                        color: black;">
                            Conoce los principales elementos de una arquitectura de información tanto en la nube, a
                            través de <b>Microsoft Azure, como on-premise</b> para proponer, diseñar e implementar las
                            mejores
                            alternativas de <b>arquitectura de información para su organización.</b>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6" style="background: #a82acb; color: white;">
                <div class="row justify-content-center">
                    <div class="col-9" style="margin-top: 40px;">
                        ...
                        <div class="icon-t">
                            ...
                            <div class="tt">148 hrs académicas</div>
                        </div>
                        <div class="icon-t">
                            <div>
                                <img src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-ds/icono-reloj.png" alt="" width="40">
                        ...
                        <div class="icon-t">
                            ...
                            <div class="tt">
                                ...
                                <div>Big Data Profesional</div>
                                <div>Certificate (BDCP)</div>
    ...
    <div class="container-sm" style="background: #2f2fd0;
    color: white;">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12" style="margin-top: 30px; padding-bottom: 35px;">
                <div class="row justify-content-center">
                    <div class="col-md-5">
                        <ul class="ds">
                            <li>Entender los principios de la
                                arquitectura empresarial y la
                                arquitectura de datos.</li>
                            <li>Alinear las necesidades de
                                información con herramientas,
                                políticas y procesos de una
                                arquitectura de datos.</li>
                        </ul>
                    </div>
                    <div class="col-md-5">
                        <ul class="ds">
                            <li>Implementar soluciones de
                                arquitectura de datos utilizando
                                Azure.</li>
                            <li>Entender las capacidades para cada
                                componente de una arquitectura de
                                datos y sus alternativas de
                                implementación.</li>
                        </ul>
                    </div>
                    <div class="col-md-5">
                        <ul class="ds">
                            <li>Desarrollar un proyecto con una
                                arquitectura de datos en la nube.</li>
                        </ul>
                    </div>
    ...
    <div class="container-sm" style=" background: #003380; padding: 30px 45px; color: white; padding-bottom: 70px;">
        ...
        <div class="wrapper">
            <div id="carouselExample" class="slider">
                ...
                <div>
                    <img class="img-fluid" src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/dennis-chavez.png" alt="Elemento 1">
                </div>
                <div>
                    <img class="img-fluid" src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/christian-fonseca.png" alt="Elemento 2">
                </div>
                <div>
                    <img class="img-fluid" src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/layla-scheli.png" alt="Elemento 3">
                </div>

                <div>
                    <img class="img-fluid" src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/tony-trujillo.png" alt="Elemento 1">
                </div>
                <div>
                    <img class="img-fluid" src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-ds/arturo-rojas.png" alt="Elemento 2">
                </div>
                <div>
                    <img class="img-fluid" src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/rolando-clavijo.png" alt="Elemento 3">
                </div>

                <div>
                    <img class="img-fluid" src="https://certificaciones.dmc.pe/suscripcion/assets/img/pea-da/christian-seijas.png" alt="Elemento 1">
                </div>
