...
class suscripcion{
	...
	public function registrar_contacto($datos){
		$gbd=Gestionbd::getInstancia();
		$sql="insert into ficha_contacto (FICHA_CONTACTO_ID,FICHA_CONTACTO_EMAIL,FICHA_CONTACTO_NOMBRES,FICHA_CONTACTO_APELLIDOS,FICHA_CONTACTO_TELEFONO,FICHA_CONTACTO_MODO,FICHA_CONTACTO_PROFESION,FICHA_CONTACTO_CENTRO_TRABAJO,FICHA_CONTACTO_CARGO,FICHA_CONTACTO_MENSAJE,FECHA_REGISTRO,FICHA_CONTACTO_FLAG_ATENDIDO,FICHA_CONTACTO_FECHA_ATENCION,FICHA_CONTACTO_FLAG_DATOS,FICHA_CONTACTO_HORARIO,FICHA_CONTACTO_USUARIO,FICHA_CONTACTO_NUM_DOCUMENTO,FICHA_CONTACTO_PAIS,FICHA_CONTACTO_PROVINCIA,FICHA_CONTACTO_SEXO) values('',:EMAIL,:NOMBRES,:APELLIDOS,:TELEFONO,:MEDIO,:PROFESION,:CENTRO_TRABAJO,:CARGO,:MENSAJE,NOW(),:FLAG_ATENDIDO,:FECHA_ATENDIDO,:DATOS,NULL,:USUARIO,:DNI,:PAIS,:PROVINCIA,:SEXO)";
		$cmd=$gbd->prepare($sql);
		    ...
		    if ($data["check_mail"]==1) {
				...
				if($status_ok==false){
				    ...
				    foreach($dataCapacitacion as $capacitacion){
					    ...
					    }else if($capacitacion["capacitacion_id"]=="1439"){
					    ...
					    }else if($capacitacion["capacitacion_id"]=="1570"){
					    ...
					    }else if($capacitacion["capacitacion_id"]=="1461"){
					    ...
					    }else if($capacitacion["capacitacion_id"]=="2407"){

							$titulo = "Charla informativa: PEA Data Architect";
					    ...
					    }else if($capacitacion["capacitacion_id"]=="1562"){
					    ...
					    }else if($capacitacion["capacitacion_id"]=="1435"){
