            ...
            <div class="row justify-content-center">
                <div class="col-md-5" style="background: white;">
                    ...
                    <div class="banner" style="background-color: white;text-align:left;margin-left: 20px;padding:0;margin-bottom:12px">
                        ...
                        <div>
                            <img src="https://dmc.pe/uploads/logo2-dmc-2019.png" width="110" height="57" style="margin-top: 14px; margin-bottom: 10px;">
                        </div>
                        <p style="color:#808080;font-size:10pt;margin-top: 10px;">Por favor bríndanos tus datos para enviarte información sobre:</p>
                        <p style="color: #2a7bb7; border: 2px solid transparent; border-left-color: #2A7BB8; padding-left: 7px;font-weight:bold;font-size:13pt;"><?= $capacitacion['nombre'] ?></p>
                    </div>
                            ...
                            <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="selectpicker" id="tDocumento" name="tDocumento" required="">
                ...
                <div class="col-md-5" style="padding: 0;">
                    <img src="https://certificaciones.dmc.pe/suscripcion/assets/img/datacohete.png" width="100%" alt="">
                </div>
            </div>
        </div>
    </div>
