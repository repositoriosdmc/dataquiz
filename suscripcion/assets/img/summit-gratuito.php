            ...
            <div class="row justify-content-center">
              <div class="col-md-4" style="background: white;">
                ...
                <div class="banner">
                    ...
                    <div>
                        <img src="https://certificaciones.dmc.pe/suscripcion/assets/img/logo-summit.png" width="120" alt="">
                    </div>
                </div>
                    ...
                    <div style="text-align: left; margin-top: 30px;">
                        <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="centro_trabajo" name="centro_trabajo"  required placeholder="">
                            </div>
