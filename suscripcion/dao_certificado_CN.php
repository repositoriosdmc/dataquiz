...
class certificadoPDF extends FPDF
{
    ...
    public function pdf_agregar_imagen($tipo)
    {
        ...
        if ($tipo == "CURSO ONLINE" || $tipo == NULL) {
            ...
            $url = "https://survey.dmc.pe/academico/plantilla/CertificadoCN.png";
    ...
    public function generar_certificado($codigo, $nombre, $apellidos, $capacitacion, $horas, $calificacion, $fechaFin, $tipo = NULL, $fechaIni = NULL)
    {
        ...
        $textoCertificado = "CONSTANCIA DE NOTAS";
            ...
            $textoEspecializadoCurso = "El área de Asistencia Académica de DMC, deja constancia que";
            ...
            $detalle["nombre"]["position"] = array(125, 85);
            ...
            $detalle["honor"]["text"] = "Concluyó satisfactoriamente el curso de";

            $detalle["honor"]["position"] = array(46, 96);

            $detalle["honor"]["tamanio"] = 12;

            $detalle["honor"]["color"] = array(0, 35, 47);

            $detalle["honor"]["center"] = "ok";

            $detalle["honor"]["fuente"] = "Geometria-regular";

            $detalle["capacitacion_t"]["text"] = $capacitacion;

            $detalle["capacitacion_t"]["position"] = array(46, 103);
            ...
            $detalle["capacitacion"]["position"] = array(125, 140);
            ...
            $detalle["capacitacion_2"]["position"] = array(125, 145);
