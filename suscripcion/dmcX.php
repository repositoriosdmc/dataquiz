				...
				<div class="b23envolver">
					...
					<div class="b23formulario" style="margin-bottom: 30px;">
						...
						<form name="form" method="post" action="controller/controller_suscripcion.php" novalidate="novalidate" id="form">
							<?php if ($capacitacion): ?>
							    <li style="font-size: 27px; font-weight: bold; color: #0a60ff;"><?=$concurso==1 ? "Concurso de Conocimiento de " : ""?><?=$capacitacion?></li>
                            ...
                            <input type="hidden" name="capacitacion_id" id="capacitacion_id" value=<?=$GtCurso?>>
							<ul>
