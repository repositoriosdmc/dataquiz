    ...
    <div>
        <div class="container" style=" margin-top: 25px; margin-bottom: 25px; ">
            <div class="row justify-content-center">
                <div class="col-md-8" style="background: #f3f3f3">
                    <!-- Banner -->
                    ...
                    <div class="pasos" id="paso2" style="background: #f3f3f3;">
                        ...
                        <div style="text-align: left; margin-top: 30px;">
                            <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                                <input type="hidden" name="cursos" id="cursos" value='2683'>
                                ...
                                <input  type="hidden" value="0" id="datos" name="datos" >
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="exampleFormControlInput1">Carrera profesional</label>
                                        <input type="text" class="form-control" id="profesion" name="profesion"  required placeholder="">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="exampleFormControlInput1">Puesto laboral actual</label>
                                        <input type="text" class="form-control" id="cargo" name="cargo"  required placeholder="">
                                    </div>

                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="exampleFormControlInput1">Empresa donde labora actualmente</label>
