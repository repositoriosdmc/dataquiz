        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-4" style="background: white;">
                    <!-- Banner -->
                    <div class="banner" style="background-color: #069ec1">
                        <!--<div class="slogan">#AprendeConLosPioneros</div>-->
                        <div>
                            <img src="https://certificaciones.dmc.pe/suscripcion/assets/img/summit/LogoLivDataSumit.png" width="120" alt="">
                        </div>
                        ...
                        <div style="margin: 46px 0;">
                            ...
                            <h3 style="font-size: 14px; margin: 16px 65px;">Gracias por registrarte, pronto te enviaremos mayores detalles sobre tu registro.</h3>
