                ...
                <div class="col-md-4" style="background: white;">
                    ...
                    <div class="banner" style="background-color: #002945">
                        ...
                        <div style="margin: 46px 0;">
                            ...
                            <h3 style="font-size: 14px; margin: 16px 65px;">Gracias por registrarse, te llegarán los accesos por correo.</h3>

                            <h3 style="font-size: 14px; margin: 16px 65px;">No olvides revisar la bandeja de "no deseados"</h3>
                    ...
                    <div style="background: #86cff0; color: #002945; display: inline-block; text-align: center; padding: 30px 80px; font-size: 15px; font-weight: 500; line-height: 1.4; ">
                        ...
                        <div style="padding-top: 29px; text-align: center; padding-bottom: 0;">
                            ...
                            <a href="https://api.whatsapp.com/send?phone=<?=$celular?>&text=Hola, deseo más información sobre el AI - Analytics Summit 2021 y las promociones vigentes." target="_blank"><img src="https://survey.dmc.pe/suscripcion/assets/img/whatsapp.png" width="50"></a>
