        		...
        		<form action="controller/controller_persona.php" id="form" method="post">
                    ...
                    <div class="row">        
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" id="centro_trabajo" name="centro_trabajo" pattern="[A-Za-z\sÁÉÍÓÚáéíóúÑñ]{2,}" placeholder="..." required>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cargo" name="cargo" pattern="[A-Za-z\sÁÉÍÓÚáéíóúÑñ]{2,}" placeholder="..." required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Seleccione el curso para concursar por una beca</label>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mensaje" name="mensaje" placeholder="..." required>
                            </div>
                        </div>
                    </div>
