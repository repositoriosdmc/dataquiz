            ...
            <div class="row justify-content-center">
              <div class="col-md-4" style="background: white;">
                ...
                <div class="banner" style="background: white;">
                    ...
                    <div>
                        <img src="https://certificaciones.dmc.pe/suscripcion/assets/img/logo-summit.png" width="220" alt="">
                    </div>
                </div>
                ...
                <div class="pasos" id="paso2">
                    ...
                    <div>
                        <div class="tercer-texto">
                            Brindanos tus datos para recibir los accesos a los eventos gratuitos del Summit.
                        </div>
                    </div>
                    <!-- Formulario -->
                    <div style="text-align: left; margin-top: 30px;">
                        <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                            <input type="hidden" name="cursos" id="cursos" value="1458">
                            ...
                            <input type="hidden" name="nomCapacitacion" id="nomCapacitacion" value="AI & Analytics Summit One Day">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Centro de labores</label>
                                <input type="text" class="form-control" id="centro_trabajo" name="centro_trabajo"  placeholder="">
                            </div>
