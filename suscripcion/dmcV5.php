            ...
            <div class="row justify-content-center">
              <div class="col-md-4" style="background: white;">
                ...
                <div class="banner">
                    ...
                    <div>
                        <img src="https://dmc.pe/uploads/logo-dmc-2019.png" width="120" alt="">
                    </div>
                </div>
                <!--  Condicional 1 ↓ --> 
                            ...
                            <div>
                                <? foreach ($curso as $key => $value) :  $categoria = $value["categoria"]; $linea = $value["linea"];?>
                                    ...
                                    <? } ?>
                                        ...
                                        <? $herramienta = $linea ;} 
                                        $search = array("ESPECIALIZACIÓN EN ", "ESPECIALIZACIÓN ", "PEA - ", "PEA "," - ");
                                        $replace   = array(""); 
                                        $texto = str_replace($search, $replace, $value['nombre']);
                                        ?>   
                                    ...
                                    <label id="capa[]-error" class="error" for="capa[]" style="display: none;">Seleccione máximo 3 cursos</label>
                                    <div style="margin-top: 45px;">
                                        <a href="#siguiente" class="boton" id="siguienteB">Siguiente</a>
                                    </div>
                ...
                <div class="pasos" id="paso2" style="display: none;">
                    ...
                    <div style="text-align: left; margin-top: 30px;">
                        <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                            ...
                            <input type="hidden" name="nomCapacitacion" id="nomCapacitacion">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-70234620-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-70234620-1');
</script>
...
<script>
    (function(h,o,t,j,a,r){
        ...
        h._hjSettings={hjid:2593094,hjsv:6};
