...
<head>
    ...
    <style>
        ...
        .boton {
            ...
            box-shadow: -3px 1px 17px #176d86;
            border: 1px solid #008cb5;
        }

        @font-face {
            font-family: 'net';
            src: url('https://certificaciones.dmc.pe/suscripcion/assets/fonts/FontsFree-Net-Geometria-Light.ttf') format('truetype');
        }

        @font-face {
            font-family: 'Geometria-Medium';
            src: url('https://certificaciones.dmc.pe/suscripcion/assets/fonts/Geometria-Medium.ttf') format('truetype');
        }

        @font-face {
            font-family: 'pirulen';
            src: url('https://certificaciones.dmc.pe/suscripcion/assets/fonts/pirulen-rg.otf') format('opentype');
        }
    ...
    <div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-11" style="background: url(https://certificaciones.dmc.pe/suscripcion/assets/img/FondoSummit.jpg); background-size: contain;">
                    <div class="col-md-7">
                        <!--  Condicional 2 ↓ -->

                        <div class="pasos" id="paso2">
                            <p style="font-size: 10px; text-align: left; color: #bbbbbb; margin: 20px 0;">Por favor brindanos tus datos para enviarte más información sobre:</p>
                            <div>
                            ...
                            <div style="text-align: left; margin-top: 30px;">
                                <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <button type="submit" class="boton" id="button" style="float:right">Enviar</button>
                                        <div>
