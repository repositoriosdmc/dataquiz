                    ...
                    <div class="pasos" id="paso2">
                        ...
                        <div style="text-align: left; margin-top: 30px;">
                            <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                                ...
                                <? if ($GtCapacitacion == 15) {
                                    $datos = $suscripcion->listado_productoV2(); 
                                    }elseif($GtCapacitacion == 1576){
                                        $datos = $suscripcion->listado_productoV3();
                                    }elseif($GtCapacitacion == 1514){
                                        $datos = $suscripcion->listado_productoV4();
                                    } 
                                     if($datos){?>
                                    <div class="row">
                                        <div class="form-group col">
                                            <label for="exampleFormControlInput1">Capacitación en Interés</label>
                                            <select class="form-control" id="cInteres" name="cInteres" required="">
                                                <option value="">Seleccione</option>
