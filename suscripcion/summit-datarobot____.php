...
header("location:https://certificaciones.dmc.pe/suscripcion/gracias-summit-data-robot.php");
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://certificaciones.dmc.pe/suscripcion/assets/css/selectize.default.css">
    <style>
        .multiselect {
            margin-top:10px;
}
...
<body style="background: #f1f1f1;">
        ...
        <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-4" style="background: white;">
                <!-- Banner -->
                <div class="banner" style="background: #002945;">

                    <div>
                        <img src="https://certificaciones.dmc.pe/suscripcion/assets/img/summit-white.png" width="220" alt="">
                    </div>
                </div>
                ...
                <div class="pasos" id="paso2">
                    <!-- Paso 2↓ -->
                    <div>
                        <div class="tercer-texto" style="margin-top: 15px;">
                            Por favor bríndanos tus datos para confirmar tu asistencia, enviarte información y accesos a la ponencia.
                        </div>
                    </div>
                    <!-- Formulario -->
                    <div style="text-align: left; margin-top: 30px;">
                        <form id="form" name="form" method="POST" action="controller/controller_suscripcion.php">
                            <input type="hidden" name="cursos[]" id="cursos" value="1615">
                            <input type="hidden" name="atendido" id="atendido" value="0">
                            <input type="hidden" name="celVendedor" id="celVendedor" value="51902815695">
                            <input type="hidden" name="celular" id="celular">
                            <input type="hidden" name="nomCapacitacion" id="nomCapacitacion" value="AI & Analytics Summit 2021">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="apellidos" name="apellidos"  required placeholder="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="centro_trabajo" name="centro_trabajo"  required placeholder="">
                            </div>
                            ...
                            <div style="margin-top: 15px;text-align: center;margin-bottom: 35px;">
                                <button type="submit" class="boton" id ="button" style="background-color: #002945;">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function selected_capacitacion(){
            ...
            var otros_curso = "one-"+id;console.log(capacitacion);
        ...
        $(document).ready(function(){
            ...
            $("#tDocumento").change(function(){
                ...
                if( valor == "DNI" && pais == "Peru" ){
                    ...
                    $("#num_documento" ).rules( "add" ,{"pattern":/^[a-zA-Z0-9]{3,50}$/});
            ...
            $('#siguiente,#siguienteB').click(function(){
                ...
                if($("#capaForm").valid()==true){
                    ...
                    hj('stateChange', 'https://certificaciones.dmc.pe/suscripcion/dmc.php#siguiente');
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-NMYZ2Y13X4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-NMYZ2Y13X4');
</script>
    <!-- Facebook Pixel Code -->
    <script>
