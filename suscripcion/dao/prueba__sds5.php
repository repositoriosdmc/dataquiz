...
$correos = $suscripcion->lista_email_ficha_contacto(864);
...
$titulo = "Modelos ARIMA – Link acceso";
...
$enviado=$suscripcion->send_mail($titulo,"marco.medrano@dataminingperu.com","","","","",$titulo,$body);
