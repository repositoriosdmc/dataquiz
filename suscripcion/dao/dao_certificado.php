    ...
    public function pdf_agregar_imagen($tipo){
        ...
        if($tipo == "CURSO ONLINE" || $tipo == NULL){
            ...
            /*$assets["selloDataDriven"] = array(
                "url"=>"https://survey.dmc.pe/academico/plantilla/dataDriven2021.png",
                "posicion"=>array(210,70,0,65)
            );

            $assets["logoAzul"] = array(
                "url"=>"https://survey.dmc.pe/academico/plantilla/logoDMC2021.png",
    ...
    public function generar_certificado($codigo,$nombre,$apellidos,$capacitacion,$horas,$calificacion,$fechaFin,$tipo=NULL,$fechaIni=null)
    {
        ...
        if($tipo == "CURSO POWER"){
            ...
            if($calificacion >=14 ){
                ...
                $textoEspecializadoCurso = "Por haber aprobado la";
            ...
            $detalle["especializado"]["position"]=array(125,101);
            ...
            $detalle["capacitacion"]["text"] = "INTRODUCCIÓN A LA VISUALIZACIÓN";

            $detalle["capacitacion"]["position"] = array(125,111);

            $detalle["capacitacion"]["tamanio"] = 18;

            $detalle["capacitacion"]["color"] = array(0,40,79);

            $detalle["capacitacion"]["fuente"] = "Geometria-Bold";

            $detalle["capacitacion"]["center"] = "ok";

            $detalle["capacitacion_2"]["text"] = "DE DATOS CON GOOGLE DATA STUDIO";

            $detalle["capacitacion_2"]["position"] = array(125,119);

            $detalle["capacitacion_2"]["tamanio"] = 18;

            $detalle["capacitacion_2"]["color"] = array(0,40,79);
            ...
            $detalle["horas_b"]["text"] = "Realizado desde el 19 de Mayo hasta el ".strftime("%d de %B del %Y",  strtotime($fechaFin)).",";
            ...
            $horas_acamedicas = "completando un total de ".$detalle["horas"]["text"]." horas académicas";

            $detalle["horas"]["position"] = array(125,140);

            $detalle["horas"]["tamanio"] = 14;

            $detalle["horas"]["color"] = array(87,87,86);

            $detalle["horas"]["fuente"] = "Geometria-regular";

            $detalle["horas"]["center"] = "ok";
