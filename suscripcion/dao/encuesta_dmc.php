      ...
      <div class="col-md-8" style="background: white url(https://survey.dmc.pe/suscripcion/assets/img/particulas.png); background-repeat: repeat; background-size: contain;">
        ...
        <div>
          <p>
            ...
            invitamos a participar de nuestro curso “Introducción a la Visualización de Datos con Power BI”, una
            iniciativa que busca fomentar el crecimiento profesional a partir del manejo de herramientas de inteligencia
            de negocio.
          </p>
          <p>
            El curso consta de 16 horas académicas bajo la modalidad de sesiones en vivo, es totalmente gratuito y las
            vacantes son limitadas. Las primeras 150 personas en registrarse recibirán una confirmación de su matrícula.
            En caso tu registro sea posterior al cierre de vacantes, aún tendrás opción de participar en el curso pues
            realizaremos un sorteo de nuevas vacantes entre todos los que no alcanzaron un cupo.
          </p>
          <p>
            ¡Sigamos fortaleciendo la comunidad analítica! #NoPodemosParar
          </p>
        </div>
        ...
        <div class="row g-2 mb-3">
          <div class="col-md">
            ...
            <select class="form-select" id="pais" name="pais" aria-label="Floating label select example" required>
