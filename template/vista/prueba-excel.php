          ...
          <div class="row justify-content-center align-items-center">
              <div class="col-md-6 col-sm-6" >
                  <div class="pt-2 pr-5 pb-2 pl-5 contenido-card " style="border-radius: 5px; background-color:white " >
                      <div class="">
                          <label class="form-check-label" ><b>Prueba Excel</b></label>
                      </div>
                  </div>
              </div>
              <div class="col-2">
                  <div class="form-check d-flex align-items-center justify-content-start" >
                  <button type="button"  style="color:white;border-radius: 12px;" value="21" data-nombre="AFP INTEGRA" class="btn btn-primary pt-2 pr-5 pb-2 pl-5 btn-continuar" name="button"> Iniciar</button>
  ...
  $(document).ready(function() {
   ...
   /* $.ajax({
      ...
      success: function(data) {
        ...
        data.forEach((item, i) => {
           if (item.estado_examen === "pendiente" && item.formulario == 3 ) {
          //    if (item.estado_examen === "pendiente" ) {
            contador++;
      html += `
      <div class="container mt-2 mb-3" >
          <div class="row justify-content-center align-items-center">
...
$(document).on('click','.btn-comenzar',function(){
  ...
  window.location.href = '../../../template/vista/formulario-excel.php?cap=' + window.btoa(valorForm)+ '&nom=' + window.btoa(nombreSeleccionado);
