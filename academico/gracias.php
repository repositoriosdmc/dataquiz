            ...
            <div class="row justify-content-center">
                <div class="col-md-4" style="background: white;">
                    ...
                    <div class="banner">
                        ...
                        <div>
                            <img src="https://dmc.pe/uploads/logo-dmc-2019.png" width="120px" alt="">
                        </div>
                    </div> 
                    <!--  Condicional 1 ↓ --> 
                    ...
                    <div style="background: #1fd268; padding: 17px 50px; color: white; display: inline-block; text-align: center;">
                        Si deseas una atención inmediata, comunícate con una asesora comercial aquí: como sdfasd
                        <div style="padding-top: 45px; text-align: center; padding-bottom: 45px; background: #1fd268">
                        <?php if($celular){ ?>
                            <a href="https://api.whatsapp.com/send?phone=<?=$celular?>" target="_blank"><img src="https://survey.dmc.pe/academico/plantilla/whatsapp.png"></a>
                        <?php } ?>
                        </div>
                    </div>
