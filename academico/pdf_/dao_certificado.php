...
class certificadoPDF{
    ...
    public function generar_certificado($codigo,$nombre,$apellidos,$capacitacion,$horas,$calificacion,$fechaFin,$tipo=NULL)
    {
        ...
        if($tipo == "CURSO POWER"){
            ...
            $detalle["nombre"]["position"] = array(126,83);
            ...
            $detalle["apellidos"]["text"] = $apellidos;

            $detalle["apellidos"]["position"] = array(126,93);
            ...
            $detalle["especializado"]["position"]=array(128,108);
